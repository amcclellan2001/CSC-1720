...
bool arrayListType<elemType>::isEmpty() const
{
   if (list[0] == NULL)
	...
	{
		cout << "List has values and is not empty." << endl; 
		return false;
	}
} // //end isEmpty
...
bool arrayListType<elemType>::isFull() const
{
	...
	else
	{
		...
		cout << "List is not full and still has " << temp << " spaces left." << endl;  
		return false;
	}
}  //end isFull
...
int arrayListType<elemType>::listSize() const
{
    int temp = maxSize - length;
	 ...
	 cout << "The current list size is " << length << "." << endl;
	 cout << "There is " << temp << " spaces left." << endl;
...
{
	 cout << "The current max list length is " << maxSize << "." << endl;
